...
DNS is managed via a Route53 hosted zone created by the `dns` module. The parent zone is in a separate AWS account. After deployment:

1. Get the nameservers: `terraform output route53_nameservers`
2. In the parent zone, create NS records:
